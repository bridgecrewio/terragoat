resource "aws_db_instance" "default" {
  ...
  tags = merge({
    ...
    git_commit           = "5587adb93a9e625e9995bc9e2d3459001095d0ba"
    git_file             = "sai/demo/db.tf"
    git_last_modified_at = "2022-04-20 10:12:39"
    git_last_modified_by = "84868436+testsai1234@users.noreply.github.com"
    git_modifiers        = "84868436+testsai1234"
    git_org              = "testsai1234"
    git_repo             = "terragoat"
